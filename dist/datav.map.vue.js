    ...
    methods: {
      ...
      calcRowsData() {
        ...
        data = data.map((row, i) => ({ ...row,
          ...
          color: row.color ? row.color : '#1370fb'
        }));
        const rowLength = data.length;
